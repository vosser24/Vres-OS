...
RULES: dict[str, dict[str, Any]] = {
    "ARCH-001": {"title": "No circular architectural dependencies", "severity": "error", "material": True},
    "ARCH-002": {"title": "shared must not depend on domains", "severity": "error", "material": True},
    "ARCH-003": {"title": "shared must not depend on feature modules", "severity": "error", "material": True},
    "ARCH-004": {"title": "domains must not depend on feature modules", "severity": "error", "material": True},
    "ARCH-005": {"title": "feature modules must not depend on sibling module internals", "severity": "error", "material": True},
    "ARCH-006": {"title": "cross-boundary imports must not use explicit private/internal paths", "severity": "error", "material": True},
    "ARCH-007": {"title": "substantive modules should carry local ownership instructions", "severity": "warning", "material": True},
    "ARCH-008": {"title": "substantive modules should expose an intentional public API", "severity": "warning", "material": True},
    "ARCH-009": {"title": "large files are responsibility-split warning signals", "severity": "warning", "material": False},
    "ARCH-010": {"title": "established applications require an architecture alignment plan", "severity": "error", "material": True},
}

PROFILES: dict[str, dict[str, Any]] = {
    "minimal": {
        "description": "Small application or utility; add layers only when responsibilities justify them.",
        "required_principles": ["ownership", "tests", "secret-safety", "dependency-discipline"],
    },
    "frontend-web": {
